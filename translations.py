...
_STRINGS: Dict[str, Dict[str, str]] = {
    ...
    "log_downloaded": {"en": "{file} downloaded.", "tr": "{file} indirildi."},
    "log_java_ok": {"en": "Java {v} requirement satisfied.", "tr": "Java {v} gereksinimi karşılandı."},
    "log_java_missing": {"en": "Required Java {v} was not found on this system.", "tr": "Gerekli Java {v} bu sistemde bulunamadı."},
    "log_java_installing": {"en": "Installing Java {v} automatically (Eclipse Temurin)…", "tr": "Java {v} otomatik kuruluyor (Eclipse Temurin)…"},
    "log_java_ready": {"en": "Java {v} installed and ready.", "tr": "Java {v} kuruldu ve hazır."},
    "log_running_installer": {"en": "Running the platform installer…", "tr": "Altyapı yükleyicisi çalıştırılıyor…"},
    "log_building": {"en": "Compiling {t} with BuildTools — this can take several minutes…", "tr": "{t} BuildTools ile derleniyor — bu birkaç dakika sürebilir…"},
    "log_cleanup": {"en": "Removing temporary build files…", "tr": "Geçici derleme dosyaları temizleniyor…"},
